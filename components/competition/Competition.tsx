...
// ===============================
// Competition: แสดงรายการการแข่งขันแบบ Swiper
// ===============================
...
export default function Competition() {
  return (
    <section className="relative bg-black text-white py-12 md:py-24 px-6 overflow-hidden">
      ...
      <div className="absolute top-1/11 right-0 w-32 h-32 md:w-56 md:h-56 bg-gray-500/20 blur-lg md:blur-xl rounded-full translate-x-1/2 -translate-y-1/2 pointer-events-none" />
