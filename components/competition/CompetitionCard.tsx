...
// ===============================
// CompetitionCard: การ์ดแสดงข้อมูลการแข่งขัน
// ===============================
import Link from "next/link";
import { CompetitionItem } from "@/instances/competition-data";
import { FiCode } from "react-icons/fi";
import Image from "next/image";

type Props = { item: CompetitionItem };

export default function CompetitionCard({ item }: Props) {
  return (
